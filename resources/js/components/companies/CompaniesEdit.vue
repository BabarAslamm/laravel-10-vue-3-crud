<template>
    <div class="flex mb-4 place-content-end">
        <router-link :to="{ name: 'companies.index' }"  class="text-sm font-medium bg">
    ...
    <div v-if="errors">
        <div v-for="(v, k) in errors" :key="k" style="background-color: darkred;" class="bg-red-400 text-white rounded font-bold mb-4 shadow-lg py-2 px-4 pr-0">
